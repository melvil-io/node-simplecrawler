...
var Crawler = function(host, initialPath, initialPort, interval) {
    ...
    // localAddress
    crawler.localAddresses  = undefined;
...
Crawler.prototype.fetchQueueItem = function(queueItem) {
    ...
    if (crawler.localAddresses && crawler.localAddresses.length > 0 ) {
        requestOptions.localAddress = crawler.localAddresses[Math.floor(Math.random()*crawler.localAddresses.length)];
    };
